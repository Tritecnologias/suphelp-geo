      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="mailto:comercial@suphelp.com.br" className="text-slate-600 hover:text-primary font-medium transition flex items-center gap-1">
            ...
            <Link 
              to="/cadastro" 
              className="bg-primary hover:bg-secondary text-white px-5 py-2.5 rounded-full font-semibold shadow-md transition transform hover:-translate-y-0.5"
            >
              Começar Grátis
            </Link>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-t border-slate-100 shadow-xl absolute w-full">
          <div className="px-4 pt-2 pb-6 space-y-2">
            ...
            <a href="mailto:comercial@suphelp.com.br" className="block px-3 py-3 text-base font-medium text-slate-600 hover:text-primary hover:bg-slate-50 rounded-md">Fale Conosco</a>
            <Link to="/login" className="block px-3 py-3 text-base font-medium text-slate-600 hover:text-primary hover:bg-slate-50 rounded-md">Login</Link>
            <div className="pt-2">
               <Link 
                 to="/cadastro"
                 className="block w-full text-center bg-primary hover:bg-secondary text-white px-5 py-3 rounded-lg font-semibold shadow-md transition"
               >
                Começar Grátis
              </Link>
            </div>
