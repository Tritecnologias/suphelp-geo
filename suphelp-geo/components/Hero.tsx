    ...
    <section className="bg-gradient-to-br from-cyan-400 to-primary text-white pt-20 pb-28 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mb-16">
          <button className="bg-white text-primary hover:bg-slate-100 px-8 py-4 rounded-lg font-bold shadow-lg transition transform hover:-translate-y-1 text-lg flex items-center justify-center gap-2">
